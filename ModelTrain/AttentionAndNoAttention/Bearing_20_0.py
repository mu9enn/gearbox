...
##加载bearing_20_0数据
bearing_20_0_labels = [np.where(wavelet_datasets['class_names'] == label)[0][0] for label in BearingLabel_20_0]
print(bearing_20_0_labels)
train_data_mask = np.isin(train_labels, bearing_20_0_labels)
test_data_mask = np.isin(test_labels, bearing_20_0_labels)
...
#训练模型
attention_path = "SavedModels/Seed_49/Bearing_20_0_Attention.pth"
no_attention_path = "SavedModels/Seed_49/Bearing_20_0_NoAttention.pth"
save_graph_path = "SavedGraphs/Seed_49/Bearing_20_0.png"
...
#保存通道和空间权重
save_path = './SavedWeights/Seed_49/Bearing_20_0.npz'
weights = {
