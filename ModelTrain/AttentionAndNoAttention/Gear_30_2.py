...
##加载gear_30_2数据
gear_30_2_labels = [np.where(wavelet_datasets['class_names'] == label)[0][0] for label in GearLabel_30_2]
print(gear_30_2_labels)
train_data_mask = np.isin(train_labels, gear_30_2_labels)
test_data_mask = np.isin(test_labels, gear_30_2_labels)
...
#训练模型
attention_path = "SavedModels/Seed_49/Gear_30_2_Attention.pth"
no_attention_path = "SavedModels/Seed_49/Gear_30_2_NoAttention.pth"
save_graph_path = "SavedGraphs/Seed_49/Gear_30_2.png"
...
#保存通道和空间
save_path = './SavedWeights/Seed_49/Gear_30_2.npz'
weights = {
