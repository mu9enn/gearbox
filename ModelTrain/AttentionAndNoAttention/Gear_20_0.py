...
print(train_data.shape, train_labels.shape,test_data.shape, test_labels.shape,class_num)
...
print(train_data_mask.shape, train_data_mask.shape)
...
#训练模型
attention_path = "SavedModels/Seed_49/Gear_20_0_Attention.pth"
no_attention_path = "SavedModels/Seed_49/Gear_20_0_NoAttention.pth"
save_graph_path = "SavedGraphs/Seed_49/Gear_20_0.png"
...
#保存通道和空间
save_path = './SavedWeights/Seed_49/Gear_20_0.npz'
weights = {
