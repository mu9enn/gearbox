...
# ===================== 【你只改这里 4 个位置】 =====================
model_6ch_path = "../SavedModels_6ch\\Seed_42\\Gear_30_2.pth"  # 你的6通道模型
model_4ch_path = "..\\SavedModels_4ch\\Seed_42\\Gear_30_2.pth"  # 你的4通道模型
...
plt.tight_layout()
plt.savefig("Performance_Comparison(Gear_30_2).png", dpi=600, bbox_inches='tight')
plt.close()