...
#模型加载
model_path_attention = '../../ModelTrain/AttentionAndNoAttention/SavedModels/Seed_56/Gear_30_2_Attention.pth'
model_path_no_attention = '../../ModelTrain/AttentionAndNoAttention/SavedModels/Seed_56/Gear_30_2_NoAttention.pth'
...
if __name__ == '__main__':
    ...
    save_path = os.path.join(save_dir, 'Gear_30_2_ShapValues.npz')
