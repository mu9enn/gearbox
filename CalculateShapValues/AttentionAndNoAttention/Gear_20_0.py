...
#模型加载
model_path_attention = '../../ModelTrain/AttentionAndNoAttention/SavedModels/Seed_56/Gear_20_0_Attention.pth'
model_path_no_attention = '../../ModelTrain/AttentionAndNoAttention/SavedModels/Seed_56/Gear_20_0_NoAttention.pth'
...
if __name__ == '__main__':
    ...
    #构建gear_20_0解释数据集和背景数据集,每种故障类型取50个样本
    ##获取每种故障标签
    gear_20_0_fault_labels = [np.where(wavelet_datasets['class_names'] == label)[0][0] for label in GearLabel_20_0]
    # print(fault_labels)
    back_label = np.where(wavelet_datasets['class_names'] == 'gear_normal_20_0')[0][0]
    # print(back_label)
    ...
    explain_samples = []
    for gear_20_0_label in gear_20_0_fault_labels:
        mask_train = np.isin(train_labels, gear_20_0_label)
        mask_test = np.isin(test_labels, gear_20_0_label)
    ...
    save_path = os.path.join(save_dir, 'Gear_20_0_ShapValues.npz')
