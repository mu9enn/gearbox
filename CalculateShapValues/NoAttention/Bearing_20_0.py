...
#加载数据
wavelet_path = '../../wavelet_dataset/bearing_20_0.npz'
...
#模型加载
model_path = '../../ModelTrain/NoAttention/SavedModels_6ch/Seed_70/Bearing_20_0.pth'
...
if __name__ == '__main__':
    ...
    save_path = os.path.join(save_dir, 'Bearing_20_0.npz')
